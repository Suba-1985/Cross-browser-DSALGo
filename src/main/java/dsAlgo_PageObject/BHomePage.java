...
public class BHomePage {
	...
	//@FindBy(xpath="//button[text()='Get Started']")private	WebElement getStartedH_btn;
   ...
   { 
	 //new WebDriverWait(driver,Duration.ofSeconds(20)).until(ExpectedConditions.visibilityOf(menudropdown));
	 		menudropdown.click();
	 			...
	 			new WebDriverWait(driver,Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(item));
